...
awaitable<void> run_party(
    ...
    constexpr size_t log_nitems = 24;
    constexpr size_t nitems = 1ULL << log_nitems;
    constexpr size_t target_ind = 44;



    // std::array<uint8_t, log_nitems> a{};
    // std::array<uint8_t, log_nitems> b{};
    uint8_t a[nitems], b[nitems];
...
int main(int argc, char* argv[]) {
    if (argc != 2) {
        std::cerr << "usage: ./dpf_mpc_test [p0|p1]\n";
        return 1;
    }
